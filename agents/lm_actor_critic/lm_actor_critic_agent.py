...
from models import LMActorCriticQNetwork

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")


class LMActorCriticAgent:
    def __init__(
        self,
        tb: logger.Logger,
        log: Callable[..., None],
        ...
        self.target_network = LMActorCriticQNetwork(
            tb=tb,
            log=log,
            vocab_size=1,
            envs=envs,
    ...
    def encode(self, obs: List[str]):
        ...
        """
        # return self.tokenizer.encode(obs)
    ...
    def update(self):
        ...
        # Each item in state_batch contains the obs, description and inventory as lists of token ids.
